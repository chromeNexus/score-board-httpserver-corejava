 ...
 *
 * Configuration properties enumeration
 */
public enum ConfigProperties {
    ...
    LOGOUT_TIMEOUT_PERIOD_CHECK((getProperty("LOGOUT_TIMEOUT_PERIOD_CHECK") != null) ? getProperty("LOGOUT_TIMEOUT_PERIOD_CHECK") : String.valueOf(1 * 60 * 1000)),
